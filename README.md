...
| [[Day 30] 使用TensorFlow.js建置DNN手寫數字辨識分類器]() | [Video](https://www.youtube.com/watch?v=SgXH2ydT1KU&list=PLXSkku8eiD-iFRBr11rV83579hing3gMU&index=30)  | [PDF](./30.使用TensorFlow.js建置DNN手寫數字辨識分類器/30.使用TensorFlow.js建置DNN手寫數字辨識分類器.pdf)  | [Code](https://github.com/1010code/digit-recognizer-tensorflowJS) |
