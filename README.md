...
| [[Day 26] 使用Heroku部署機器學習API]() | [Video]()  | [PDF](./26.使用Heroku部署機器學習API/26.使用Heroku部署機器學習API.pdf)  | [Code](https://github.com/1010code/Flask-API-example-with-ML-model-heroku) |
